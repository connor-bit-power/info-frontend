  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-white/20 rounded-md",
        day_range_end: "day-range-end",
        day_selected: "bg-white text-black hover:bg-white hover:text-black focus:bg-white focus:text-black",
        day_today: "bg-white/10 text-white",
        day_outside: "day-outside text-white/30 opacity-50 aria-selected:bg-white/10 aria-selected:text-white/30 aria-selected:opacity-30",
